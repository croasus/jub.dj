...
function DB(config, models) {
  ...
  this.validateLogin = function(username, passwordHash, callback, errCb) {
    if (typeof errCb !==  'function') { errCb = defaultErrCb; }
    models.UserPreferences.findOne({ name: username, passwordHash: passwordHash },
  ...
  this.createAccount = function(username, passwordHash, email, callback, errCb) {
    if (typeof errCb !==  'function') { errCb = defaultErrCb; }
